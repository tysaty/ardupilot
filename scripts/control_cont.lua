...
-- local CTRL_CW_LAMBDA  = param_helpers.bind_add_param(CTRL_TABLE_KEY, CTRL_TABLE_PREFIX, "C_LAMBDA", 1, 40)   -- ~8 cycles, A_eff ~1.6m
-- local CTRL_CW_LAMBDA  = param_helpers.bind_add_param(CTRL_TABLE_KEY, CTRL_TABLE_PREFIX, "C_LAMBDA", 1, 60)     -- ~5 cycles, A_eff ~3.6m
...
-- local CTRL_CW_ACAP = param_helpers.bind_add_param(CTRL_TABLE_KEY, CTRL_TABLE_PREFIX, "C_ACAP", 3, 2)  -- prev (λ=40)
-- local CTRL_CW_ACAP = param_helpers.bind_add_param(CTRL_TABLE_KEY, CTRL_TABLE_PREFIX, "C_ACAP", 3, 5)          -- just above A_eff ~3.6m
...
-- achieved weave amplitude = A * lambda / (2*pi*L); smaller L => deeper weave (floor ~lambda/2pi)
local CTRL_CW_LOOK  = param_helpers.bind_add_param(CTRL_TABLE_KEY, CTRL_TABLE_PREFIX, "C_LOOK", 7, 50) -- original
-- local CTRL_CW_LOOK  = param_helpers.bind_add_param(CTRL_TABLE_KEY, CTRL_TABLE_PREFIX, "C_LOOK", 7, 20) -- prev (achieved ~1.7m)
-- local CTRL_CW_LOOK  = param_helpers.bind_add_param(CTRL_TABLE_KEY, CTRL_TABLE_PREFIX, "C_LOOK", 7, 10)     -- achieved ~3.4m, matches commanded A
